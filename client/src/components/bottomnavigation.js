...
export default function SimpleBottomNavigation({language, setLanguage}) {
  ...
  return (
    <Box sx={{ width: 500 }}>
      <BottomNavigation
        sx={{borderTop: "1px white solid", position: 'fixed', bottom: 0, left: 0, right: 0, backgroundColor: "#272822" }} 
        showLabels
        value={value}
      ...
      >
        ...
        <a href="https://www.github.com/kujuh3" target="__blank" style={{zIndex: "2", color: "white", left: "0", position: "absolute"}}><DiGithubBadge size={"3em"}/></a>
      </BottomNavigation>
    </Box>
  );
}
